...
/**
 * v1.0: First version
 * -Opens form in window based on input string. Input string needs to be formatted using the following format:
 ...
 * 
 */
public class UU95_OpenAnyFormWindow extends CustomJavaAction<Boolean>
{
	private String MendixFormString;

	public UU95_OpenAnyFormWindow(IContext context, String MendixFormString)
	{
		super(context);
